...
const UI_CLICK_GAIN = 0.137;
const UI_CONFIRM_GAIN = 0.124;
const UI_CONFIRM_SECONDARY_GAIN = 0.091;
const UI_SELECT_GAIN = 0.111;
const TERRAIN_DAMAGE_GAIN = 0.137;
const TERRAIN_BREAK_NOISE_GAIN_MIN = 0.169;
const TERRAIN_BREAK_NOISE_GAIN_MAX = 0.234;
const TERRAIN_BREAK_TONE_GAIN = 0.137;
const RUBBLE_FORM_GAIN = 0.124;
const RUBBLE_DAMAGE_GAIN = 0.111;
const RUBBLE_BREAK_GAIN = 0.156;
const FOOTSTEP_GAIN_MIN = 0.072;
const FOOTSTEP_GAIN_MAX = 0.156;
const LANDING_GAIN_MIN = 0.098;
const LANDING_GAIN_MAX = 0.234;
const NOVA_TOGGLE_GAIN = 0.124;
const NOVA_CHAT_GAIN = 0.085;
