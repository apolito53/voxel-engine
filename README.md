...
- Selected Hitscan Core uses `Left click` to fire an instant 10%-radius, 500%-speed core trace through the same partial-block bite and piercing rules; `Right click` is intentionally reserved
