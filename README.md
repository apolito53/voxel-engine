...
- Gameplay `Ground Debris Lifetime` controls how long grounded shards remain before they blink faster and disappear; `Forever` keeps them visible until distance, pressure, or manual cleanup removes them
