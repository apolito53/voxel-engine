...
- `src/partialBlocks.ts`: in-memory partial-block terrain carving, core-footprint-ranked hidden 3x3x3 bite-lattice damage visuals, stitched wrinkled partial-height surface mesh/support generation, explicit surviving-lattice collision boxes, and core-hit carve constants
