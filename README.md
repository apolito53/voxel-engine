...
- `C` while sprinting forward, or landing crouched with enough speed, starts a committed slide with a small entry shove; hold `W` to glide longer, `Space` to spring-jump out of the slide
