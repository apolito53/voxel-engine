...
- `src/partialBlocks.ts`: in-memory partial-block terrain carving, wrinkled partial-height surface mesh/support generation, and core-hit carve constants
