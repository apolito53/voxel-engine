...
12. The scroll wheel selects the current hotbar item: Unarmed, a placeable block, or Physics Core. Left click only breaks terrain while Unarmed, while right click uses the selected item by placing blocks or throwing the selected core.
