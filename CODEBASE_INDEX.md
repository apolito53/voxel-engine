...
- Persistent faceted destructible rubble cover patches, sparse sample footprints, batched absorption, bounded surface samples, direct-hit damage with small neighbor chip damage, damage-event reporting, multi-cell merge rules, walkable support-height queries, support/fall behavior, and dense terrain-block promotion: `src/rubble.ts`
