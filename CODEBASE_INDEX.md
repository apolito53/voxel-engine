...
- Short-lived settling regions, same-region debris clumping/stack contacts, pair-budget pressure relief, and batched debris-to-rubble finalization: `src/debrisSettler.ts`
...
- Persistent sloped destructible rubble cover patches, batched absorption, multi-cell merge rules, walkable support-height queries, support/fall behavior, and dense terrain-block promotion: `src/rubble.ts`
